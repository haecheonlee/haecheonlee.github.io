...
export class Wrapper {
        ...
        __classPrivateFieldSet(
            ...
            _Wrapper_endpoints,
            {
                current: (options) => {
                    ...
                    return {
                        method: "GET",
                        resource: `${__classPrivateFieldGet(
                            this,
                            _Wrapper_api,
                            "f"
                        )}/current.json?key=${__classPrivateFieldGet(
                            this,
                            _Wrapper_apiKey,
                            "f"
    ...
    request(method, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const endpointCallback = __classPrivateFieldGet(
                this,
                _Wrapper_endpoints,
                "f"
            )[method];
...
(_Wrapper_api = new WeakMap()),
    (_Wrapper_apiKey = new WeakMap()),
    (_Wrapper_endpoints = new WeakMap());
